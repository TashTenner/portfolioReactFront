  ...
  render() {
    return (
      <AboutBox>
        ...
        <StyledDiv>This was my personal motto when I started learning how to code. Learning your mother tongue from birth on is an unconscious process that takes years! No wonder learning a language and code in a conscious way is difficult. But your brain is wired to learn logical concepts. Changing my from languages or Linguistics to coding languages, by no means, was not as simple as I hoped it would be. Still, we human beings are amazing creatures and very much capable of learning how to code. Are you toying with the idea of turning to Web Development? Feel free to share your thoughts or doubts with me and I am happy to help you either to start your dream and/or keep on holding to it.</StyledDiv>
        <TangoTitle>Tango music while coding</TangoTitle>
        <StyledDiv>SOME TEXT WITH TANGO MUSIC</StyledDiv>
        <PhotoBox>
